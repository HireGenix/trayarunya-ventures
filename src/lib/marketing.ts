...
export const hero = {
  ...
  subtitle:
    'MarketiQ AI is an Autonomous Go-To-Market Operating System powered by 41 AI agents and 23 autonomous optimization loops that continuously research, strategize, create, publish, optimize, and learn across your entire go-to-market — built for both Enterprise (B2B) and Consumer (B2C/D2C) motions.',
...
export const trustLine = 'One closed GTM loop · 41 AI agents under an AI CMO · 23 autonomous loops · learns from every result · built for Enterprise (B2B) and Consumer (B2C/D2C) go-to-market';
  ...
  plans: [
    {
      ...
      features: [
        ...
        'All 41 AI agents & 23 autonomous loops',
